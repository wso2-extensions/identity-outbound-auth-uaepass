...
@PrepareForTest({ LogFactory.class, OAuthAuthzResponse.class, OAuthClientRequest.class, UAEPassDataHolder.class,
        ...
        UAEPassAuthenticatorConstants.class, AbstractApplicationAuthenticator.class, Property.class, Log.class, IdentityTenantUtil.class})
public class UAEPassAuthenticatorTest extends PowerMockTestCase {
    ...
    private static String accessToken = "fd2fffca-b5e2-466d-aac9-207382497b88";
    private static String idToken = "eyJ4NXQiOiJOVGRtWmpNNFpEazNOalkwWXpjNU1tWm1PRGd3TVRFM01XWXdOREU1TVdSbFpEZzROemM0Wk" +
    ...
    public Object[][] getCommonAuthParams() {
        ...
        return new String[][]{
                ...
                {"login_hint=$authparam{username}", "https://localhost:9443/commonauth", "The redirect URI is invalid"},
    ...
    public void testAdditionalQueryParamSeperation() throws UnsupportedEncodingException {
        ...
        String expectedURL = "https://stg-ids.uaepass.ae/oauth2/authorize&scope=" +authenticatorProperties.get("scope")+
                "&acr_values" +authenticatorProperties.get("acr_values")+ "&language"
                +authenticatorProperties.get("language");
    ...
    public void testInitiateAuthenticationRequest(String authParam, String expectedValue,
        ...
        when(mockServletRequest.getParameter("scope=openid&state=OIDC&loginType=basic&redirect_uri=https://localhost:9443/commonauth"))
                .thenReturn(authParam);
    ...
    public void testGetSubjectFromUserIDClaimURI() throws AuthenticationFailedException, FrameworkException {
        ...
        Assert.assertNotNull(uaePassAuthenticator.getSubjectFromUserIDClaimURI(mockAuthenticationContext,idTokenClaims));
    }
